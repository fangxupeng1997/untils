...
public class StringUtil {
	...
	*/
	 ...
	 * 
	 * @Title: hasLength 
	 * @Description: TODO判断源字符串是否有值，空引号(空白字符串)也算没值
	 * @param src
	 * @return
	 * @return: boolean
	 */
	 ...
	 * 
	 * @Title: hasText 
	 * @Description: TODO判断源字符串是否有值，空引号(空白字符串)和空格也算没值 (5分
	 * @param src
	 * @return
	 * @return: boolean
	 */
	 ...
	 * @Description: TODO返回中文姓名，必须以真实姓开头，百家姓在“六、附百家姓”里，名使用1-2个随机汉字(8分)，内
	 * @return
	 * @return: String
	 */
